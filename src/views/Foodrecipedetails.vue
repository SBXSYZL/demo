  ...
  data () {
    return {
      historyMsg:
          ...
          '<div>' +
          '<div style="width: 20%;text-align: right"><img  style="width: 400px;height: 250px;float:left"' +
          ...
          '<br>' +
          '<div style="width: 20%;text-align: right"><img style="width: 800px;height: 500px"' +
          ...
          '<div style="width: 20%;text-align: right"><img style="width: 800px;height: 600px"' +
